...
#define REFRESH_INTERVAL     3333     // minimum time to refresh servos in microseconds 

#define SERVOS_PER_TIMER       6     // the maximum number of servos controlled by one timer 
