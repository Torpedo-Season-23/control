...
#define UDP_SEND_FRAME 24  // 6 IMU angles, 2 pressure, 8 leakage, 4*2 converters(2 bytes for current, 1 for temperature , 1 for Vout)
#define UDP_CONVERTER_1_INDEX 16 //first converter  index in UDP_SEND_FRAME
#define UDP_CONVERTER_2_INDEX UDP_CONVERTER_1_INDEX + 4 //first converter  index in UDP_SEND_FRAME
