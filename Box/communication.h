...
public:
  ...
  void sendData(uint16_t *imu_frame,int imu_size,uint8_t current,int current_size,uint16_t pressure);
  void prep_to_send(uint16_t *imu_frame,int imu_size,uint8_t current,int current_size,uint16_t pressure);
};
