...
class TorpedoMPU: public MPU6050 {
  ...
  public:
    ...
    //      return yaw_3;
    //    }
    //    float TorpedoMPU::Return_accx() {
    //      accx = getAccelerationX();
    //      return accx;
    //    }
    //    float TorpedoMPU::Return_accy() {
    //      accy = getAccelerationY();
    //      return accy;
    //    }
    //    float TorpedoMPU::Return_accz() {
    //      accz = getAccelerationZ();
    //      return accz;
    //    }
    //    float TorpedoMPU::Return_gyrx() {
    //      gyrx = getRotationX();
    //      return gyrx;
    //    }
    //    float TorpedoMPU::Return_gyry() {
    //      gyry = getRotationY();
    //      return gyry;
    //    }
    //    float TorpedoMPU::Return_gyrz() {
    //      gyrx = getRotationZ();
    //      return gyrz;
    //    }
    float *TorpedoMPU:: communication_data() {
      calculate();
      angles[0] = roll;
      angles[1] = pitch;
      angles[2] = yaw_3;
