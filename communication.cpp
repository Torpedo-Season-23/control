...
void CommunicationClient::Init(const uint8_t pin) {
  Ethernet.init(pin);
...
//sending function
void CommunicationClient::sendData(float *imu_frame, uint8_t imu_size, uint8_t *current, uint8_t current_size, float *pressure, uint8_t pressure_size) {
...
void CommunicationClient::prep_to_send(float *imu_frame, uint8_t imu_size, uint8_t *current, uint8_t current_size, float *pressure, uint8_t pressure_size) {
