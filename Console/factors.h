...
public:
  ...
  Factor() {
    ...
    //forward low
    this->factors[FORWARD][LOW_SPEED][FRONT_LEFT1] = 1;
    this->factors[FORWARD][LOW_SPEED][FRONT_RIGHT1] = 0.8;
    this->factors[FORWARD][LOW_SPEED][BACKWARD_LEFT1] = -0.95;
    this->factors[FORWARD][LOW_SPEED][BACKWARD_RIGHT1] = 0.95;
    //forward normal

    this->factors[FORWARD][NORMAL_SPEED][FRONT_LEFT1] = 1;
    this->factors[FORWARD][NORMAL_SPEED][FRONT_RIGHT1] = 0.8;
    this->factors[FORWARD][NORMAL_SPEED][BACKWARD_LEFT1] = -0.8;
    this->factors[FORWARD][NORMAL_SPEED][BACKWARD_RIGHT1] = 0.95;

    //forward High
    this->factors[FORWARD][HIGH_SPEED][FRONT_LEFT1] = 0.98;
    this->factors[FORWARD][HIGH_SPEED][FRONT_RIGHT1] = 1;
    this->factors[FORWARD][HIGH_SPEED][BACKWARD_LEFT1] = -0.60;
    ...
    this->factors[BACKWARD][LOW_SPEED][FRONT_LEFT1] = 1;
    this->factors[BACKWARD][LOW_SPEED][FRONT_RIGHT1] = 0.8;
    this->factors[BACKWARD][LOW_SPEED][BACKWARD_LEFT1] = -0.95;
    this->factors[BACKWARD][LOW_SPEED][BACKWARD_RIGHT1] = 0.95;

    //backward Normal
    this->factors[BACKWARD][NORMAL_SPEED][FRONT_LEFT1] = 1;
    this->factors[BACKWARD][NORMAL_SPEED][FRONT_RIGHT1] = 0.8;
    this->factors[BACKWARD][NORMAL_SPEED][BACKWARD_LEFT1] = -0.95;
    this->factors[BACKWARD][NORMAL_SPEED][BACKWARD_RIGHT1] = 0.95;
    //backward High
    this->factors[BACKWARD][HIGH_SPEED][FRONT_LEFT1] = 0.98;
    this->factors[BACKWARD][HIGH_SPEED][FRONT_RIGHT1] = 1;
    this->factors[BACKWARD][HIGH_SPEED][BACKWARD_LEFT1] = -0.76;
    ...
    this->factors[RIGHT][LOW_SPEED][BACKWARD_LEFT1] = 0.9;
    this->factors[RIGHT][LOW_SPEED][BACKWARD_RIGHT1] = -0.7;
    ...
    //left
    //left Low
    this->factors[LEFT][LOW_SPEED][FRONT_LEFT1] = -0.78;
    this->factors[LEFT][LOW_SPEED][FRONT_RIGHT1] = -0.8;
    this->factors[LEFT][LOW_SPEED][BACKWARD_LEFT1] = 0.85;
    this->factors[LEFT][LOW_SPEED][BACKWARD_RIGHT1] = -0.84;
    //left Normal
